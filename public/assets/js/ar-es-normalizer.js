(() => {
  ...
  const catalogueTranslations = new Map([
    ...
    ['Pez de escama', 'أسماك ذات قشور'], ['Pez cartilaginoso', 'أسماك غضروفية'],
    ['Pescados especiales', 'أسماك خاصة'], ['Blanco / semigraso', 'أبيض / متوسط الدهن'],
    ['Azul / graso', 'أزرق / دهني'], ['Especial', 'خاص'],
    ...
    ['Según disponibilidad', 'حسب التوفر'], ['Según destino', 'حسب الوجهة'],
    ['Según mercado', 'حسب السوق'], ['Según campaña y disponibilidad', 'حسب الموسم والتوفر'],
    ['Según programa de suministro', 'حسب برنامج التوريد'],
    ['Según especie y programa de suministro', 'حسب النوع وبرنامج التوريد'],
    ['Según origen', 'حسب المنشأ'], ['Según requisitos de la destinación', 'حسب متطلبات الوجهة'],
    ['Según requisitos del destino', 'حسب متطلبات الوجهة'], ['Especificación profesional', 'مواصفة مهنية'],
    ['Specifica professionale', 'مواصفة مهنية'], ['Familia', 'الفئة'], ['Tipo', 'النوع'],
    ['Estado', 'الحالة'], ['Origen', 'المنشأ'], ['Calibre', 'المقاس'], ['Calidad', 'الجودة'],
    ['Presentación', 'التقديم'], ['Embalaje', 'التعبئة'], ['Conditionnement', 'التعبئة'],
    ['Disponibilidad', 'التوفر'], ['According to availability', 'حسب التوفر'],
    ['According to destination', 'حسب الوجهة'], ['According to market', 'حسب السوق'],
    ['Túnez', 'تونس'], ['Tunisia', 'تونس'], ['Spain', 'إسبانيا'], ['España', 'إسبانيا'],
    ['Mediterraneo', 'البحر المتوسط'], ['Atlantico', 'الأطلسي']
  ]);
  ...
  const normalizeText = (value) => {
    ...
    return raw
      ...
      .replace(/\bFresco\b/g, 'طازج').replace(/\bFresh\b/g, 'طازج')
      .replace(/\bCongelado\b/g, 'مجمد').replace(/\bFrozen\b/g, 'مجمد')
  ...
  const injectStyle = () => {
    ...
    style.textContent = `
      html[lang="ar"] main > :is(.ar-hero,.es-hero,.hero,.page-hero,[class*="hero"]) { min-height: 100vh !important; }
      html[lang="ar"] .es-hero, html[lang="ar"] .ar-hero, html[lang="ar"] .page-hero { padding-top: clamp(138px, 17vh, 188px) !important; padding-bottom: clamp(78px, 9vh, 110px) !important; }
      html[lang="ar"] .es-page .es-hero h1, html[lang="ar"] .ar-hero h1, html[lang="ar"] .page-hero h1, html[lang="ar"] .hero h1 { font-family: "Noto Sans Arabic", sans-serif !important; font-size: clamp(3rem, 7.4vw, 7.2rem) !important; line-height: .98 !important; letter-spacing: -.035em !important; text-align: right !important; }

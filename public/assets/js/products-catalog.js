(() => {
  ...
  const i18n = {
    es: {
      labels:{fish:'Pescados',shellfish:'Mariscos',cephalopods:'Cefalópodos',citrus:'Cítricos',exotics:'Frutas exóticas','core-produce':'Otras frutas',vegetables:'Hortalizas','seasonal-selection':'Temporada'},
      fresh:'Fresco', frozen:'Congelado', detail:'Ver ficha', empty:'No hay referencias activas en esta categoría.',
      catalogue:'CATÁLOGO', all:'Referencias seleccionadas.', seafood:'Productos del mar', seasonal:'Temporada'
    },
    en: {
      labels:{fish:'Fish',shellfish:'Shellfish',cephalopods:'Cephalopods',citrus:'Citrus',exotics:'Exotic fruit','core-produce':'Other fruit',vegetables:'Vegetables','seasonal-selection':'Seasonal'},
      fresh:'Fresh', frozen:'Frozen', detail:'View specification', empty:'No active references in this category.',
      catalogue:'CATALOGUE', all:'Selected references.', seafood:'Seafood', seasonal:'Seasonal'
    },
    fr: {
      labels:{fish:'Poissons',shellfish:'Fruits de mer',cephalopods:'Céphalopodes',citrus:'Agrumes',exotics:'Fruits exotiques','core-produce':'Autres fruits',vegetables:'Légumes','seasonal-selection':'Saisonnier'},
      fresh:'Frais', frozen:'Surgelé', detail:'Voir la fiche', empty:'Aucune référence active dans cette catégorie.',
      catalogue:'CATALOGUE', all:'Références sélectionnées.', seafood:'Produits de la mer', seasonal:'Saisonnier'
    },
    ar: {
      labels:{fish:'أسماك',shellfish:'مأكولات بحرية',cephalopods:'رأسيات الأرجل',citrus:'حمضيات',exotics:'فواكه استوائية','core-produce':'فواكه أخرى',vegetables:'خضروات','seasonal-selection':'موسمي'},
      fresh:'طازج', frozen:'مجمد', detail:'عرض المواصفات', empty:'لا توجد مراجع نشطة في هذه الفئة.',
      catalogue:'الكتالوج', all:'مراجع مختارة.', seafood:'منتجات البحر', seasonal:'موسمي'
    }
  };

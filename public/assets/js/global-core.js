(() => {
  ...
  load('css', '/assets/css/canonical-nav.css?v=20260822-canonical-3', 'etCanonicalNav');
  ...
  const buildProducts = () => {
    ...
    if (/\/products\/(seafood\/?|seafood\/(fish|shellfish|cephalopods)\/)\/.test(path)) details.open = true;

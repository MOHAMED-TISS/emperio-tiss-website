(() => {
  ...
  const labels = {
    ...
    ar: {
      ...
      fish: 'الأسماك',
      shellfish: 'المأكولات البحرية والقشريات',
  ...
  const paths = {
    es: {
      ...
      fish: '/products/seafood/fish/',
      shellfish: '/products/seafood/shellfish/',
      cephalopods: '/products/seafood/cephalopods/',
    ...
    en: {
      ...
      seafood: '/en/products/seafood/',
      fish: '/en/products/seafood/fish/',
      shellfish: '/en/products/seafood/shellfish/',
      cephalopods: '/en/products/seafood/cephalopods/',
      fruits: '/en/products/fruits/',
      vegetables: '/en/products/vegetables/',
      seasonal: '/en/products/seasonal/',
      markets: '/en/markets/',
      news: '/en/news/',
      contact: '/en/contact/'
    },
    fr: {
      ...
      seafood: '/fr/products/seafood/',
      fish: '/fr/products/seafood/fish/',
      shellfish: '/fr/products/seafood/shellfish/',
      cephalopods: '/fr/products/seafood/cephalopods/',
      fruits: '/fr/products/fruits/',
      vegetables: '/fr/products/vegetables/',
      seasonal: '/fr/products/seasonal/',
      markets: '/fr/markets/',
      news: '/fr/news/',
      contact: '/fr/contact/'
    },
    ar: {
      ...
      seafood: '/ar/products/seafood/',
      fish: '/ar/products/seafood/fish/',
      shellfish: '/ar/products/seafood/shellfish/',
      cephalopods: '/ar/products/seafood/cephalopods/',
      fruits: '/ar/products/fruits/',
      vegetables: '/ar/products/vegetables/',
      seasonal: '/ar/products/seasonal/',
      markets: '/ar/markets/',
      news: '/ar/news/',
      contact: '/ar/contact/'
    },
    it: {
      ...
      seafood: '/it/products/seafood/',
      fish: '/it/products/seafood/fish/',
      shellfish: '/it/products/seafood/shellfish/',
      cephalopods: '/it/products/seafood/cephalopods/',
      fruits: '/it/products/fruits/',
      vegetables: '/it/products/vegetables/',
      seasonal: '/it/products/seasonal/',
      markets: '/it/markets/',
      news: '/it/news/',
      contact: '/it/contact/'
    }
  ...
  const normalizeMenuOverlays = () => {
    doc.querySelectorAll(overlaySelector).forEach((overlay) => {
      const ownerHeader = overlay.closest(
        '.site-header,.p-header,.et-header-inner,.header-inner');
  ...
  doc.addEventListener('click', (event) => {
    ...
    if (button) {
      ...
      const open = body.classList.contains('nav-open') || body.classList.contains(
      'menu-open');
    ...
    if (!overlay) return;
    if (event.target === overlay || event.target.closest(
        '.nav-overlay-close,.intl-overlay-close')) {
      closeMenu();
      return;
    }
  ...
  initDynamicParts();
  new MutationObserver(initDynamicParts).observe(doc.body, {
    childList: true,
    subtree: true
  });

  const initContactForm = () => {
    if (!/^\/(en|fr|it|ar)\/contact\/?$/.test(window.location.pathname) && !/^\/contact\/?$/
    ...
    form.addEventListener('submit', async (event) => {
      ...
      try {
        ...
        if (!response.ok || !result.ok) throw new Error(result.error || contactCopy
        .error);
        form.reset();

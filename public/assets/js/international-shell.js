(() => {
  ...
  const cfg = {
    ...
    it: {
      home: 'Home', company: 'La nostra proposta', products: 'Prodotti', seafood: 'Prodotti del mare', fish: 'Pesce', shellfish: 'Molluschi & crostacei', cephalopods: 'Cefalopodi', fruits: 'Frutta', vegetables: 'Ortaggi', seasonal: 'Stagionale', markets: 'Mercati', news: 'Notizie', contact: 'Contatti', enquiry: 'Richiesta commerciale', whatsapp: 'Contattaci su WhatsApp', brand: 'Il tuo partner di fiducia nei mercati internazionali.', nav: 'Navigazione', productCol: 'Prodotti', companyCol: 'Azienda', legalNotice: 'Note legali', privacy: 'Privacy', cookies: 'Cookie policy', reserved: 'Tutti i diritti riservati.', disclaimer: 'Le informazioni pubblicate sono fornite a titolo informativo e non costituiscono un’offerta contrattuale.', geography: 'MADRID · SPAGNA · EUROPA · AFRICA · MEDITERRANEO', locale: 'Madrid · Europe · Africa · Mediterraneo', open: 'Apri il menu', homeAria: 'EMPERIO TISS — Home'
    }
  }[lang];
  ...
  if (!initialBrandHeader) doc.querySelectorAll('body > header, .site-header').forEach(el => el.remove());
  doc.querySelectorAll('.nav-overlay,.p-overlay,footer').forEach(el => el.remove());
  doc.body.insertAdjacentHTML('afterbegin', initialBrandHeader ? overlay : header + overlay);

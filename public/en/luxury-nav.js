...
(function(){
  ...
  function initPointer(){
    ...
    d.addEventListener('mouseover',e=>{if(e.target.closest('a,button,[role="button"],input,select,textarea,.es-card,.products-world,.fv-card,.season-row'))p.classList.add('is-hover')});
